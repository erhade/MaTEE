...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/host/xtest \
		...
		$(LOCAL_PATH)/ta/global_variable/include \
		$(LOCAL_PATH)/ta/ctx_variable/include \
		$(LOCAL_PATH)/ta/instance_variable/include \
		$(LOCAL_PATH)/ta/heap_param/include \
		$(LOCAL_PATH)/ta/heap_param_pac/include \
